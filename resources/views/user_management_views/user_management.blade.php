...
@section('content')
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        <li class="nav-item">
            <a class="nav-link active" id="admin-tab" data-toggle="tab" href="#admin" role="tab" aria-controls="home"
               aria-selected="true">New Admin Account</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" id="statuper-tab" data-toggle="tab" href="#statuper" role="tab" aria-controls="profile"
