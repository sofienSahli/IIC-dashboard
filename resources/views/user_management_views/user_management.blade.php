...
@section('content')
    ...
    <div id="users_management" xmlns:v-on="http://www.w3.org/1999/xhtml">
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link" id="super-admin-tab" data-toggle="tab" href="#super-admin" role="tab"
                   aria-controls="profile"
                   aria-selected="false">New Super Admin Account</a>
            </li>

        </ul>
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active row" id="super-admin" role="tabpanel" aria-labelledby="home-tab">
                <div class="col-12">
